        ...
        <div style={{ width: '100%', height: '100%', position: 'absolute', backfaceVisibility: 'hidden', display: 'flex', flexDirection: 'column', padding: '12px', gap: '8px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', paddingRight: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', width: '100%' }}>
              <select value={langFrom} onChange={e => setLangFrom(e.target.value)} className="nodrag" style={{ flex: 1, padding: '4px', fontSize: '0.75rem', borderRadius: '4px', outline: 'none', border: '1px solid var(--color-border)', background: 'var(--color-surface)' }}>
              ...
              <select value={langTo} onChange={e => setLangTo(e.target.value)} className="nodrag" style={{ flex: 1, padding: '4px', fontSize: '0.75rem', borderRadius: '4px', outline: 'none', border: '1px solid var(--color-border)', background: 'var(--color-surface)' }}>
                <option value="en">EN</option>
                <option value="it">IT</option>
                <option value="es">ES</option>
                <option value="fr">FR</option>
