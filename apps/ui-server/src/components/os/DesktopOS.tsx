...
export default function DesktopOS() {
  ...
  useEffect(() => {
    ...
    if (!windows['dashboard']) registerApp({ id: 'dashboard', title: 'Dashboard Archelia', icon: getImg('./icons/dashboard_abstract.jpg'), color: 'transparent', component: <Dashboard />, x: 100, y: 50, width: 1000, height: 650, desktopX: 30, desktopY: 30, desktopX_B2B: 30, desktopY_B2B: 30 });
    if (!windows['orders']) registerApp({ id: 'orders', title: 'Gestione Ordini', icon: getImg('./icons/orders_abstract.jpg'), color: 'transparent', component: <Orders />, x: 150, y: 100, width: 900, height: 600, desktopX: 30, desktopY: 130, desktopX_B2B: 30, desktopY_B2B: 130 });
    if (!windows['products']) registerApp({ id: 'products', title: 'Catalogo Prodotti', icon: getImg('./icons/products_abstract.jpg'), color: 'transparent', component: <Products />, x: 200, y: 150, width: 900, height: 600, desktopX: 30, desktopY: 230, desktopX_B2B: 30, desktopY_B2B: 230 });
    if (!windows['settings']) registerApp({ id: 'settings', title: 'Centro Sync', icon: getImg('./icons/settings_abstract.jpg'), color: 'transparent', component: <Settings />, x: 250, y: 200, width: 600, height: 400, desktopX: 30, desktopY: 330, desktopX_B2B: 30, desktopY_B2B: 330 });
    if (!windows['equalizzatore']) registerApp({ id: 'equalizzatore', title: 'Equalizzatore', icon: getImg('./icons/equalizzatore_abstract.jpg'), color: 'transparent', component: <EqualizzatoreApp />, x: 100, y: 100, width: 1100, height: 750, desktopX: 30, desktopY: 430, desktopX_B2B: 30, desktopY_B2B: 430 });
    if (!windows['marketing']) registerApp({ id: 'marketing', title: 'Marketing', icon: getImg('./icons/marketing_abstract.jpg'), color: 'transparent', component: <MarketingApp />, x: 120, y: 120, width: 1200, height: 800, desktopX: 30, desktopY: 530, desktopX_B2B: 30, desktopY_B2B: 530 });
    if (!windows['email_builder']) registerApp({ id: 'email_builder', title: 'Email Builder', icon: getImg('./icons/email_builder_abstract.jpg'), color: 'transparent', component: <EmailBuilderApp />, x: 140, y: 140, width: 1200, height: 800, desktopX: 30, desktopY: 630, desktopX_B2B: 30, desktopY_B2B: 630 });
    if (!windows['promo_manual']) registerApp({ id: 'promo-manual', title: 'Promo (Manuale)', icon: getImg('./icons/promo_manual_abstract.jpg'), color: 'transparent', component: <PromoManualApp />, x: 60, y: 60, width: 900, height: 600, desktopX: 30, desktopY: 730, desktopX_B2B: 30, desktopY_B2B: 730 });
    
    // Column 2
    if (!windows['os-settings']) registerApp({ id: 'os-settings', title: 'Impostazioni', icon: <DynamicFcIcon name="FcSettings" />, color: 'transparent', component: <OSSettingsApp />, x: 100, y: 100, width: 900, height: 700, desktopX: 130, desktopY: 30, desktopX_B2B: 130, desktopY_B2B: 30 });
    if (!windows['promo_auto']) registerApp({ id: 'promo_auto', title: 'Sconti Auto', icon: getImg('./icons/promo_auto_abstract.jpg'), color: 'transparent', component: <PromoAutoApp />, x: 180, y: 180, width: 1100, height: 800, desktopX: 130, desktopY: 130, desktopX_B2B: 130, desktopY_B2B: 130 });
    if (!windows['infinity']) registerApp({ id: 'infinity', title: 'Infinity', icon: getImg('./icons/infinity_abstract.jpg'), color: 'transparent', component: <InfinityApp />, x: 200, y: 200, width: 1100, height: 800, desktopX: 130, desktopY: 230, desktopX_B2B: 130, desktopY_B2B: 230 });
    if (!windows['images']) registerApp({ id: 'images', title: 'Immagini Asset', icon: getImg('./icons/images_abstract.jpg'), color: 'transparent', component: <ImagesApp />, x: 250, y: 150, width: 900, height: 600, desktopX: 130, desktopY: 330, desktopX_B2B: 130, desktopY_B2B: 330 });
    if (!windows['typesense']) registerApp({ id: 'typesense', title: 'Typesense', icon: getImg('./icons/typesense_abstract.jpg'), color: 'transparent', component: <TypesenseApp />, x: 220, y: 220, width: 1100, height: 800, desktopX: 130, desktopY: 430, desktopX_B2B: 130, desktopY_B2B: 430 });
    if (!windows['analytics']) registerApp({ id: 'analytics', title: 'Centro Analisi', icon: getImg('./icons/analytics_abstract.jpg'), color: 'transparent', component: <AnalyticsApp />, x: 100, y: 100, width: 1200, height: 800, desktopX: 130, desktopY: 530, desktopX_B2B: 130, desktopY_B2B: 530 });
    if (!windows['logs']) registerApp({ id: 'logs', title: 'System Logs', icon: getImg('./icons/logs_abstract.jpg'), color: 'transparent', component: <LogsApp />, x: 120, y: 120, width: 1000, height: 750, desktopX: 130, desktopY: 630, desktopX_B2B: 130, desktopY_B2B: 630 });
    if (!windows['roblox_game']) registerApp({ id: 'roblox_game', title: 'Roblox Obby', icon: getImg('./icons/themes/roblox/roblox_game.jpg'), color: 'transparent', component: <RobloxMinigame />, x: 150, y: 150, width: 800, height: 600, desktopX: 130, desktopY: 730, desktopX_B2B: 130, desktopY_B2B: 730 });
    
    // Column 3
    if (!windows['calendar_app']) registerApp({ id: 'calendar_app', title: 'Calendario', icon: <DynamicFcIcon name="FcCalendar" />, color: 'transparent', component: <CalendarApp />, x: 150, y: 100, width: 1000, height: 700, desktopX: 230, desktopY: 30, desktopX_B2B: 230, desktopY_B2B: 30 });
    if (!windows['notes_app']) registerApp({ id: 'notes_app', title: 'Note', icon: <DynamicFcIcon name="FcDocument" />, color: 'transparent', component: <NotesApp />, x: 200, y: 150, width: 1000, height: 700, desktopX: 230, desktopY: 130, desktopX_B2B: 230, desktopY_B2B: 130 });
    if (!windows['users_management']) registerApp({ id: 'users_management', title: 'Utenti', icon: <DynamicFcIcon name="FcBusinessman" />, color: 'transparent', component: <UsersApp />, x: 250, y: 150, width: 1000, height: 700, desktopX: 230, desktopY: 230, desktopX_B2B: 230, desktopY_B2B: 230 });
  }, []);
