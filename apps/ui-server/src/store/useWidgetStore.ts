...
export const useWidgetStore = create<WidgetState>((set) => ({
  widgets: [
    ...
    { id: 'default-weather', type: 'weather', x: window.innerWidth > 800 ? window.innerWidth - 300 : 50, y: 250, size: 'large' },
    { id: 'default-calc', type: 'calculator', x: window.innerWidth > 800 ? window.innerWidth - 300 : 50, y: 550, size: 'medium' }
  ],
