      ...
      <div className="flex flex-col gap-2 w-full mt-2" onClick={(e) => { e.preventDefault(); e.stopPropagation(); }}>
        <div className="flex gap-2 w-full h-10">
          ...
          <button 
            ...
            className={`flex-1 bg-black text-white hover:bg-[#00C800] transition-colors font-bold text-xs rounded flex items-center justify-center gap-1 ${isPending || disabled ? 'bg-gray-400 cursor-not-allowed opacity-80' : ''} ${className || ''}`}
          >
